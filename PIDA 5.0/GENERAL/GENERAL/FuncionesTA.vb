...
Module FuncionesTA
    ...
    Public Sub LlenaNomSem(ByVal drEmpleado As DataRow, Periodo As String, dtAsist As DataTable)
        Try
            ...
            Dim dias_pago_nomina As Double = 0.0 ' Dias para pago en nomina
            ...
            '===AO: 2024-11-08: Guardar en variables, los campos que no se calculan con el evaluador, que son externos, pero deben de mantener su valor y no estar en ceros
            Dim _bono_prod As Double = 0.0, dtCamposNoCalc As New DataTable
            dtCamposNoCalc = sqlExecute("select bono10 from nomsem where ano+periodo='" & Periodo.Substring(0, 4) & Periodo.Substring(4, 2) & "' and reloj='" & R & "'", "TA")
            If Not dtCamposNoCalc.Columns.Contains("Error") And dtCamposNoCalc.Rows.Count > 0 Then
                Try : _bono_prod = dtCamposNoCalc.Rows(0).Item("bono10") : Catch ex As Exception : _bono_prod = 0.0 : End Try
            End If
            ...
            dias_pago_nomina = dias_nomina(R, Periodo)
            ...
            ActualizaNomSem(R, "bono06", dias_pago_nomina, Periodo.Substring(0, 4), Periodo.Substring(4, 2)) ' Días para pago en Nómina
            ' ORDEN IMPORTANTE!!
            ...
            ActualizaNomSem(R, "bono10", _bono_prod, Periodo.Substring(0, 4), Periodo.Substring(4, 2)) ' ==Bono de productividad
