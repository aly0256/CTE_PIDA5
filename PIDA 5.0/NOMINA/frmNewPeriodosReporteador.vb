...
Public Class frmNewPeriodosReporteador
    ...
    Private Sub frmNewPeriodosReporteador_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            'Periodo activo
            dtTemp = sqlExecute("SELECT MAX(ano+periodo) as AnoPeriodo FROM nomina WHERE periodo<='53'", "NOMINA")
            ...
            btnSeleccionarFiltros.Visible = False
    ...
    Private Sub rbnFiltros_CheckedChanged(sender As Object, e As EventArgs) Handles rbnFiltros.CheckedChanged
        If rbnFiltros.Checked = True Then
            btnSeleccionarFiltros.Visible = True
        End If
    End Sub

    Private Sub rbnTodos_CheckedChanged(sender As Object, e As EventArgs) Handles rbnTodos.CheckedChanged
        If rbnTodos.Checked = True Then
            btnSeleccionarFiltros.Visible = False
            frmReporteadorNomina.FiltroRelojes = ""
        End If
    End Sub

    Private Sub btnSeleccionarFiltros_Click(sender As Object, e As EventArgs) Handles btnSeleccionarFiltros.Click
        Try
            frmFiltroNomina.Prefiltro = True
            frmFiltroNomina.Show()
            frmFiltroNomina.Prefiltro = False
