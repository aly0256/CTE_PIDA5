Public Class frmFiltroNomina
    ...
    Public Prefiltro As Boolean = False
    ...
    Private Sub frmFiltro_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If Prefiltro = True Then
            Me.Size = New Size(483, 650)
            GroupBox2.Size = New Size(428, 498)
            lstFiltros.Size = New Size(420, 68)
            GroupBox1.Location = New Point(82, 553)
            GroupBox3.Visible = False
            'Else
            '    Me.Size = New Size(1165, 783)
            '    GroupBox2.Size = New Size(568, 498)
            '    lstFiltros.Size = New Size(1110, 68)
            '    GroupBox1.Location = New Point(372, 673)
    ...
    Private Sub ListarResultado(valor As String)
        ...
        frmReporteadorNomina.FiltroRelojes = valor
        Try
        ...
        Try
            ...
            Select Case Tipo
                ...
                Case "char"
                    ...
                    dtIncluyendo = sqlExecute("SELECT DISTINCT " & Campo & "  FROM " & Tabla & " WHERE " & Campo & " <> ''  AND NOT " & Campo & " IS NULL ORDER BY " & Campo, "nomina")
