...
Public Class frmReporteadorNomina
    ...
    Public FiltroRelojes As String
    ...
    Private Sub frmReporteador_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            '== Se obtiene el anio y periodo del reporteador de nomina              24feb22
            Try
                AnioPeriodoReporteadorNom.Clear()
                For Each x As String In lstPeriodos.Items
                    AnioPeriodoReporteadorNom.Add(x)
                Next
    ...
    Private Sub bgw_DoWork(sender As Object, e As System.ComponentModel.DoWorkEventArgs) Handles bgw.DoWork
        ...
        FiltroRelojes = FiltroRelojes.Replace("'", "''").Replace("COD_DEPTO", "NOMINAVW.COD_DEPTO").Replace("ALTA", "NOMINAVW.ALTA").Replace("BAJA", "NOMINAVW.BAJA").Replace("COD_HORA", "NOMINAVW.COD_HORA").Replace("COD_PLANTA", "NOMINAVW.COD_PLANTA").Replace("RELOJ", "NOMINAVW.RELOJ").Replace("COD_TIPO", "NOMINAVW.COD_TIPO").Replace("COD_TIPO_NOMINA", "NOMINAVW.COD_TIPO_NOMINA").Replace("COD_TURNO", "NOMINAVW.COD_TURNO")
        Dim CiaSimple As String = CiaReporteador.Replace("''", "")
        Try

            For Each I In PeriodosReporteador    ''Agregar SPreporteadornomina    frmperiodoreporteador 
                A = I.Substring(0, 4)
                P = I.Substring(4, 2)
                T = I.Substring(6, 1)
                ...
                dtResultadoNomina = sqlExecute("EXEC ReporteadorNominaTPeriodos @Cia = '" & CiaReporteador & "',@ano = '" & A & "', @periodo = '" & P & _
                                         "',@Nivel = '" & NivelConsulta & "', @TipoPeriodo = '" & T & "', @reloj = '" & IIf(FiltroRelojes = "" Or FiltroRelojes = Nothing, "'", FiltroRelojes & "'"), "nomina")
                dtResultadoNomina.Columns.Add("periodos")
